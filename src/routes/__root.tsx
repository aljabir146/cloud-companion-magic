...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "High-performance LXC and VM management with multi-node clustering, real-time monitoring, and port forwarding." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "TigerHost — VPS Panel" },
      { name: "twitter:description", content: "High-performance LXC and VM management with multi-node clustering, real-time monitoring, and port forwarding." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/4585fde9-b953-4217-b809-4e7b285e255e/id-preview-70e6704b--039dc6fd-b43f-4fbc-b49f-1c66184543ab.lovable.app-1778680258789.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/4585fde9-b953-4217-b809-4e7b285e255e/id-preview-70e6704b--039dc6fd-b43f-4fbc-b49f-1c66184543ab.lovable.app-1778680258789.png" },
    ],
